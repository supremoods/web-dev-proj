...
const signUpBtnlink = document.querySelector(".btn-sign-up");
const showSignUp = document.querySelector(".signUp_box");
const hideSignUp = document.querySelector(".hideS-U");
...
hideSignIn.onclick = ()=>{
    hideMain.classList.remove("hide");
    showSignIn.classList.remove("show");
}

signUpBtnlink.onclick = ()=>{
